...
def show_SS():
    ...
    if star_img is not None and not(multiple):
        ...
        #Gerar pdf
            my_star.publish_pdf(filename="res.pdf",open_file=False, logo="https://raw.githubusercontent.com/JSanry/teste-pylinac/USER-EXT/logoP.png" , metadata={'Físico': Fis, 'Unidade': Unit, 'Parâmetro': Par, 'Data': data_teste, 'Raio Analise':r})
