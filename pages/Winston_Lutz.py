...
def show_WL():
    ...
    if len(img_wl)<2:
        ...
        #Gerar pdf
            ...
            wl.publish_pdf(filename="res.pdf",open_file=False, logo="https://raw.githubusercontent.com/JSanry/teste-pylinac/USER-EXT/logoP.png" , metadata={'Físico': Fis, 'Unidade': Unit, 'Data': data_teste})
