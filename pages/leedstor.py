...
def show_LD():
    ...
    if img_ld is not None:  
        ...
        #Gerar pdf
            ...
            leeds.publish_pdf(filename="res.pdf",open_file=False, logo="https://raw.githubusercontent.com/JSanry/teste-pylinac/USER-EXT/logoP.png" , metadata={'Físico': Fis, 'Unidade': Unit, 'Data': data_teste})
