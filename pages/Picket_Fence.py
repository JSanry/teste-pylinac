...
def show_PF():
    ...
    if pfimg is not None:
        ...
        #Gerar pdf
            ...
            pf.publish_pdf(filename="res.pdf",open_file=False, logo="https://raw.githubusercontent.com/JSanry/teste-pylinac/USER/logoN.png" , metadata={'Físico': Fis, 'Unidade': Unit, 'Data': data_teste})
